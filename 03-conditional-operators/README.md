# **Булеви изрази, оператори if и switch**

![](images/easier_way.jpg)
...
---
<details><summary>За който е <b> rusty</b> </summary>
<p>

- При b<sup>2</sup> – 4ac > 0 уравнението има 2 различни реални корена 
- При b<sup>2</sup> – 4ac = 0 уравнението има 1 двоен корен
- При b<sup>2</sup> – 4ac < 0 няма реални корени
...
Точката (x,y) се намира в кръга точно когато $x^2+y^2 <= r^2$
и се намира под правата точно когато $y < kx$
</details>
...
<details><summary>Подсказка</summary>
Ако приемем, че c е най-дългата отсечка, то триъгълник може да се построи точно когато $c < a+b$  <br>
В такъв случай за триъгълника важи следното:<br>
Ако $c^2 < a^2 + b^2$, то триъгълника е остроъгълен  <br>
Ако $c^2 = a^2 + b^2$, то триъгълника е правоъгълен  <br>
Ако $c^2 > a^2 + b^2$, то триъгълника е тъпоъгълен  
</details>
...
<details><summary>!SPOILER! Как да намерим най-голямото от 3 числа </summary>
<p>

![](images/Find-largest-of-three-given-numbers-in-c.png)
</p>
</details>
...
### Задача 14
Напишете програма, която приема число **n** (-1000 <= **n** <= 1000), която изписва стойността на **n** с думи. Помислете за някакъв pattern, който може да се преизползва. Може и на [6lyokavica](https://www.youtube.com/watch?v=1d8B2QIdKho)
