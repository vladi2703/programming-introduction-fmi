...
## Задача 8 - Цифри
Дадено е неотрицателно цяло число с не повече от 9 цифри. Да се изведе сбора на цифрите му на четни позиции. Както и информация коя цифра по колко пъти се среща в числото. 
